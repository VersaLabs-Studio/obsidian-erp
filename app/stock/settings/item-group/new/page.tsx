...
import { useCreateItemGroupMutation, useItemGroupOptionsQuery } from "@/hooks/data/useItemGroupQuery";
import { itemGroupFormSchema, ItemGroupFormData, defaultItemGroupFormValues, formToFrappe } from "@/lib/schemas/item-group";
...
export default function CreateItemGroupPage() {
  ...
  const parentOptions = optionsData?.data?.item_groups || [];
